...
export interface Subcategory {
  ...
  categoryId: string; // The category this subcategory belongs to
...
export interface Expense {
  ...
  categoryId: string; // The category of the expense
  subcategoryId?: string; // Optional subcategory of the expense
